...
export function CertificateIcon(props: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="m21.7 13.35-1.36 1.36L21.85 16.2l-1.41 1.41-1.49-1.5-1.36 1.36-1.5-3.13ZM12 2 4.42 5.37A2 2 0 0 0 3 7.32V12c0 5 3.5 9.5 9 11 1.55-.42 2.97-1.16 4.21-2.13" />
...
export function MessengerIcon(props: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M12 2C6.48 2 2 6.16 2 11.18c0 2.83 1.42 5.34 3.65 7v3.42l3.34-1.83c.89.25 1.84.39 2.81.39 5.52 0 10-4.16 10-9.18C22 6.16 17.52 2 12 2zm1.06 12.31-2.6-2.77-5.04 2.77 5.55-5.89 2.66 2.77 4.98-2.77-5.55 5.89z" />
    </svg>
  );
}
...
export function GitHubIcon(props: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M12 .3a12 12 0 0 0-3.79 23.39c.6.11.82-.26.82-.58v-2.05c-3.34.73-4.04-1.61-4.04-1.61-.55-1.39-1.34-1.76-1.34-1.76-1.09-.74.08-.73.08-.73 1.21.09 1.84 1.24 1.84 1.24 1.07 1.84 2.81 1.31 3.5 1 .1-.78.42-1.31.76-1.61-2.66-.3-5.47-1.33-5.47-5.93 0-1.31.47-2.39 1.24-3.23-.13-.3-.54-1.53.12-3.18 0 0 1.01-.32 3.3 1.23a11.45 11.45 0 0 1 6 0c2.29-1.55 3.3-1.23 3.3-1.23.66 1.65.25 2.88.12 3.18.77.84 1.24 1.92 1.24 3.23 0 4.61-2.81 5.62-5.48 5.92.43.37.81 1.1.81 2.22v3.29c0 .32.22.7.82.58A12 12 0 0 0 12 .3" />
    </svg>
  );
}
...
export function WaveIcon(props: Props) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M11.86 14.7a1.5 1.5 0 0 1-2.12 2.12L4.79 11.86a1.5 1.5 0 0 1 2.12-2.12l4.95 4.96Z" />
      <path d="M16.04 12.6 8.96 5.5a1.5 1.5 0 1 1 2.13-2.12l7.07 7.08a1.5 1.5 0 1 1-2.12 2.13Z" />
      <path d="M19.4 13.7a8.5 8.5 0 0 1-2.5 6.04l-1.06-1.06a7 7 0 0 0 0-9.9 7 7 0 0 0-9.9 0L4.86 7.74a8.5 8.5 0 0 1 14.55 5.96Z" opacity=".4" />
    </svg>
  );
}
